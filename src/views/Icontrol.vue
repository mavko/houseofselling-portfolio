			...
			<div class="grid gap-12 lg:grid-flow-col md:grid-flow-col">
				...
				<div class="text-2xl font-light lg:text-4xl md:text-3xl">
					...
					<a
						...
						href="https://www.linkedin.com/in/aejfager/"
						target="_blank"
						rel="noopener noreferrer"
						data-cursor="-opaque"
						>Anton Fagerberg's</a
					>
					2 min pitch at 500 startups to get a good grasp of why we created
					iControl
					<br />
					<div
						class="z-0 my-20"
					...
					>
						<a
							href="//www.slideshare.net/500startups/500-demo-day-batch-19-icontrol"
							title="500 Demo Day Batch 19: iControl"
							target="_blank"
							class="btn-underlined"
							>500 Demo Day Batch 19: iControl Slideshare</a
						>
					</div>
					<div
						class="mt-10 sm:text-2xl md:text-2xl lg:text-3xl"
