    ...
    <section className="mx-auto max-w-3xl p-4 pb-24 sm:py-24">
      <div className="space-y-8">
        <section className="relative mx-auto h-full w-full overflow-hidden rounded-xl  shadow-2xl shadow-white/5 ring-1 ring-white/20 backdrop-blur-sm">
          ...
          <div className="relative flex leading-6 ">
            <div className="mt-2 flex flex-none items-center border-b border-t border-b-white border-t-transparent px-4 py-1">
              ...
              />
              <span className="pt-1.5 text-base text-white/80 font-medium">01_setup</span>
            </div>
          ...
          <div className="p-4 sm:p-8 space-y-6">
            ...
            <section className="space-y-3">
              ...
              <p className="text-pretty text-sm font-medium text-neutral-300">
                Might as well build these into my head and become a cyborg at this
                point, that's how much I've used them since purchase. Worth every
                penny times 2.
              </p>
            </section>
            <section>
              ...
              <p className="text-sm font-medium text-neutral-300">
                Complete immersion. Complete overkill. And used exlusively at the
                office.
              </p>
            </section>
            <section>
        ...
        <section className="relative mx-auto h-full w-full overflow-hidden rounded-xl  shadow-2xl shadow-white/5 ring-1 ring-white/20 backdrop-blur-sm">
          ...
          <div className="relative flex leading-6 ">
            <div className="mt-2 flex flex-none items-center border-b border-t border-b-white border-t-transparent px-4 py-1">
              <Image
                ...
                className="player_dither__2ctrc absolute left-0 top-0 h-full w-16 rotate-180 -scale-y-150 opacity-50 brightness-100 invert"
              />
              <span className="pt-1.5 text-base text-white/80 font-medium">02_Tools</span>
            </div>
            <div className="mt-2 flex flex-auto items-center rounded-tl border-y border-l border-r-0 border-white/10 bg-neutral-900 lg:rounded-tr">
            </div>
          </div>
          ...
          <div className="p-4 sm:p-8 space-y-6">
            ...
            <section>
              ...
              <p className="text-sm font-medium text-neutral-300">
                Making the AI feature describe errors for me as someone who spends
                minimal time on backend is golden.
              </p>
            </section>
            <section>
              <h2 className="text-base font-semibold text-neutral-200">
        ...
        <section className="relative mx-auto h-full w-full overflow-hidden rounded-xl  shadow-2xl shadow-white/5 ring-1 ring-white/20 backdrop-blur-sm">
          ...
          <div className="relative flex leading-6 ">
            <div className="mt-2 flex flex-none items-center border-b border-t border-b-white border-t-transparent px-4 py-1">
              <Image
                ...
                className="player_dither__2ctrc absolute left-0 top-0 h-full w-16 rotate-180 -scale-y-150 opacity-50 brightness-100 invert"
              />
              <span className="pt-1.5 text-base text-white/80 font-medium">02_Design</span>
            </div>
            <div className="mt-2 flex flex-auto items-center rounded-tl border-y border-l border-r-0 border-white/10 bg-neutral-900 lg:rounded-tr">
            </div>
          </div>
          ...
          <div className="p-4 sm:p-8 space-y-6">
            <section className="">
              <h2 className="text-base font-semibold text-neutral-200">Figma</h2>
              <p className="text-pretty text-sm font-medium text-neutral-300">
        ...
        <section className="relative mx-auto h-full w-full overflow-hidden rounded-xl  shadow-2xl shadow-white/5 ring-1 ring-white/20 backdrop-blur-sm">
          ...
          <div className="relative flex leading-6 ">
            <div className="mt-2 flex flex-none items-center border-b border-t border-b-white border-t-transparent px-4 py-1">
              <Image
                ...
                className="player_dither__2ctrc absolute left-0 top-0 h-full w-16 rotate-180 -scale-y-150 opacity-50 brightness-100 invert"
              />
              <span className="pt-1.5 text-base text-white/80 font-medium">02_Productivity</span>
            </div>
            <div className="mt-2 flex flex-auto items-center rounded-tl border-y border-l border-r-0 border-white/10 bg-neutral-900 lg:rounded-tr">
            </div>
          </div>
          <div className="p-4 sm:p-8 space-y-6">
            ...
            <section>
              <h2 className="text-base font-semibold text-neutral-200">Linear</h2>
              <p className="text-sm font-medium text-neutral-300">
                ...
                too. Much like Raycast, the Linear team has done a phenomenal job.
              </p>
            </section>
            <section>
              <h2 className="text-base font-semibold text-neutral-200">
            ...
            <section>
              ...
              <p className="text-sm font-medium text-neutral-300">
                ...
                simply stick to the native apple app. Gets the job done and I can
                easily invite my wife to document things together. Any serious
                ideas or projects later gets imported into Linear.
              </p>
              <span className="max-w-sm text-pretty text-xs font-bold text-neutral-300">
