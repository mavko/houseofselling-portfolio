...
const ideation1 = mediaUrl('bundled/craft/icontrol/sketches/ideation1.jpg')
const ideation2 = mediaUrl(
  'bundled/craft/icontrol/sketches/icontrol_iphone_sketches.jpg',
)

const dashboardBlueprint = mediaUrl(
  'bundled/craft/icontrol/screens/icontrol_dashboard_blueprint.png',
)
const dashboardModals = mediaUrl(
  'bundled/craft/icontrol/screens/icontrol_dashboard_modals.png',
)
const ipadBlueprint = mediaUrl(
  'bundled/craft/icontrol/screens/icontrol-ipad-blueprint.png',
)
const iphoneMockup = mediaUrl(
  'bundled/craft/icontrol/icontrol_iphone_photo.jpg',
)

const onTheField = mediaUrl('bundled/craft/icontrol/onthefield.jpg')
const onTheField2 = mediaUrl(
  'bundled/craft/icontrol/icontrol_constructionsite_inspection.jpg',
)
const onTheField3 = mediaUrl('bundled/craft/icontrol/icontrol-jm.jpg')

const bobby = mediaUrl('bundled/craft/icontrol/mascot_bobbythebuilder.png')
const logoFin = mediaUrl('bundled/craft/icontrol/icontrol_logo.png')
const icontrolTeam = mediaUrl('bundled/craft/icontrol/team-icontrol.jpg')
