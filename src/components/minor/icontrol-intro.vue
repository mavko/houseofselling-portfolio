<template>
	<div>
		<div class="max-w-full min-w-full shadow-xl" style="width: 862px">
			<div class="ring-1 ring-slate-900/5">
				<div
				...
				>
					...
					>
						<div class="flex items-center">
							...
							<svg
								...
								height="24"
								fill="none"
								class="flex-none ml-4 text-slate-400 dark:text-slate-50"
							>
								<path
									d="m15 7-5 5 5 5"
									stroke="currentColor"
							...
							><svg
								...
								height="24"
								fill="none"
								class="flex-none ml-2 text-slate-400 dark:text-slate-50"
							>
								<path
									d="m10 7 5 5-5 5"
									stroke="currentColor"
						...
						<div>
							<div
								class="flex items-center justify-center w-4/5 py-1 mx-auto text-xs font-medium leading-6 rounded-md bg-slate-100 ring-1 ring-inset ring-slate-900/5 dark:bg-slate-800 dark:text-slate-50 text-slate-900"
							>
								<svg
									viewBox="0 0 20 20"
									fill="currentColor"
									class="text-slate-300 w-3.5 h-3.5 mr-1.5 dark:text-slate-50"
								>
									<path
										fill-rule="evenodd"
					...
					<div class="grid overflow-hidden text-xs leading-5">
						<div
							class="pointer-events-none select-none text-slate-900 font-medium px-4 py-1.5 flex items-center justify-center space-x-2 dark:text-slate-50 text-center"
						>
							<div class="truncate">
								iControl - The Construction Documentation Source of Truth
							</div>
						</div>
					</div>
				</div>
				<div
					class="relative pb-8 -mb-8 bg-white border-t border-slate-200 rounded-b-xl dark:bg-slate-800 dark:border-slate-900/50 text-slate-50"
				>
					<router-link to="/ispect">
						<div class="relative">
							<div
								data-magnetic
								data-cursor="-opaque"
								class="absolute z-10 w-full h-full p-4 space-y-4 md:p-12 md:space-y-8 roundeed-xl bg-slate-900/60 hover:bg-slate-900/70"
							>
								<div
									class="flex items-center space-x-2 text-lg font-medium align-middle"
								>
									<div>
										<img
								...
								<p class="text-lg">Click to read more</p>
							</div>
