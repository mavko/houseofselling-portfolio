...
export default function ArticleDropdown() {
  return (
    ...
    <Menu>
      <MenuButton className="no-underline group cursor-pointer relative rounded-full p-px text-xs font-semibold leading-6  text-white/80 inline-block">
        <span className="absolute inset-0 overflow-hidden rounded-full">
          <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
        </span>
        <div className="relative flex space-x-1 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/30 h-10">
      ...
      >
        <MenuItem>
          <Link href="/craft/makings-of-ispect" className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10">
        ...
        <MenuItem>
          <Link href="/craft/makings-of-icontrol" className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10">
            <ForwardIcon className="size-4 fill-white/80" />
            Makings of iControl
