...
const current: ProjectEntry[] = [
	{
		...
		year: [2026, 'ongoing'],
		image: mediaUrl('images/projects/open.svg'),
...
const projectsData: ProjectEntry[] = [
	{
		...
		image: mediaUrl('images/projects/minibrf-se.svg'),
	...
	},
	{
		...
		image: mediaUrl('images/projects/heredium-co.svg'),
...
const business: ProjectEntry[] = [
	{
		...
		year: [2025, 'ongoing'],
		image: mediaUrl('images/projects/din-fastighetsforvaltare.png'),
	...
	},
	{
		...
		year: [2017, 'ongoing'],
		image: mediaUrl('images/projects/besiktningsman-se.png'),
	...
	},
	{
		...
		year: [2023, 2024],
		image: mediaUrl('images/projects/drykit-co.png'),
...
const startups: ProjectEntry[] = [
	...
	},
	{
		...
		year: [2014, 2017],
		image: mediaUrl('bundled/craft/icontrol-header.jpg'),
