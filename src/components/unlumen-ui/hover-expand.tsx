...
const rowEntranceFilterTransition = (
	delaySec: number,
							...
							<div className='flex w-full items-center gap-3'>
								<motion.span
									className={cn(
										...
										showMedia ? 'text-white' : 'text-white'
									)}
									animate={{
								...
								{item.sublabel ? (
									<motion.span
										className={cn(
											'shrink-0 font-mono text-xs font-medium tracking-widest uppercase transition-colors duration-200',
											showMedia ? 'text-white/55' : 'text-white'
										)}
										animate={{
