globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/sebastianselling/Developer/houseofselling-portfolio/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///Users/sebastianselling/Developer/houseofselling-portfolio/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/sebastianselling/Developer/houseofselling-portfolio/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { createFetch as createFetch$1, Headers } from 'file:///Users/sebastianselling/Developer/houseofselling-portfolio/node_modules/ofetch/dist/node.mjs';
...
const getClientManifest = () => import('/Users/sebastianselling/Developer/houseofselling-portfolio/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/sebastianselling/Developer/houseofselling-portfolio/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
